...
print('Hello\nScript de création de fichier SAS d importation de données\n\n\n')
...
#Non du fichier brut données brutes .csv     
donnees = input('\nNom du fichier de donnéees brute en .csv:')
position_colonne_produit = input('\nPosition de la colonne produit :')
position_colonne_produit = int(position_colonne_produit)
...
print("Le chemin des données brutes :\n",adresse_donnees,"\n")
...
%let date = {date};\n\n'                 
        ...
        for row in csv_reader:
            if line_count == 1:
                for variable in row:
                    if line_count == position_colonne_produit:
