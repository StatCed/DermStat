...
OBJET : fichier "driver" qui donne les chemin d'accès au fichiers
		de l'étude
...
EXEMPLE : 
			...
			%let fichier_données =	_17E4571.csv
...
*-------------------------------------------------------------------
Chemin spécifique à l étude analysée;
%let chemin = %str(D:\StructureEtude\1.XXEXXXX_Draft\2.Analyse\);

*---------------------------
Fichier .csv données brutes;
%let fichier_données = test.csv;


*------------------------
Bibliothèque des données;
...
*---------------------------------------------------------
Bibliothèque des varaibles d environnement et des formats;
libname env "&chemin.0.Data\2.Environnement";


*------------------------------------------------
Chemin complet du Fichier .csv de données brutes;
filename raw "&chemin.0.Data\&fichier_données";

*-------------------------------------
Répertoire des sortie RTF des données;
...
*Bibliothèque des macro-programmes;
