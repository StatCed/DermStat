...
/*************************************************mise à jour par mgu v2***********************************
Règles:
1.Le produit est toujours dans la première colonne
2.Le sujet est toujours la deuxième position
3.vartransposedeb a été initialisé à 3, à modifier si nous avons d'autres variables "autresVariables"
4.TypeStudy Intra ou Para
5.delta est le type de variation à calculer -abs: di-d0
                                            -rel: (di-d0)/d0
                                            -Aucun
/**********************************************************************************************/
...
%macro table (
    ...
    vartransposedeb=3,                /*vartransposedeb a été initialisé à 3, à modifier si nous avons d'autres variables "autresVariables"*/				
...
%if %upcase(&TypeEtude)=INTRA and %eval(&NombreProduits > 1) %then %do;
		...
		proc sort data=&tableSortie out=&tableSortie; 
			by &autresVariables subject parametern parameter /*productn product*/ time;
